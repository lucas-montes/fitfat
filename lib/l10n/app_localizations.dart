...
abstract class AppLocalizations {
  ...
  /// No description provided for @activeSeance.
  ///
  /// In en, this message translates to:
  /// **'Active Workout'**
  ...
  /// No description provided for @untitledWorkout.
  ///
  /// In en, this message translates to:
  /// **'Untitled Workout'**
  String get untitledWorkout;
  ...
  /// No description provided for @recentWorkout.
  ///
  /// In en, this message translates to:
  /// **'Recent workout'**
  String get recentWorkout;
