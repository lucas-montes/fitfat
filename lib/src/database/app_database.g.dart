...
class Store extends DataClass implements Insertable<Store> {
  ...
  Store copyWith({String? id, String? name, int? createdAt}) => Store(
    id: id ?? this.id,
    name: name ?? this.name,
    createdAt: createdAt ?? this.createdAt,
  );
...
class $IngredientPicturesTable extends IngredientPictures
    with TableInfo<$IngredientPicturesTable, IngredientPicture> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $IngredientPicturesTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'ingredient_pictures';
  @override
  VerificationContext validateIntegrity(
    Insertable<IngredientPicture> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  IngredientPicture map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $IngredientPicturesTable createAlias(String alias) {
    return $IngredientPicturesTable(attachedDatabase, alias);
  }
}

class IngredientPicture extends DataClass
    implements Insertable<IngredientPicture> {
  final String id;
  ...
  IngredientPicturesCompanion toCompanion(bool nullToAbsent) {
    return IngredientPicturesCompanion(
      id: Value(id),
  ...
  factory IngredientPicture.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  IngredientPicture copyWithCompanion(IngredientPicturesCompanion data) {
    return IngredientPicture(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('IngredientPicture(')
          ..write('id: $id, ')
  ...
  @override
  int get hashCode =>
      Object.hash(id, ingredientId, imagePath, sortOrder, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is IngredientPicture &&
          other.id == this.id &&
...
class IngredientPicturesCompanion extends UpdateCompanion<IngredientPicture> {
  final Value<String> id;
  ...
  final Value<int> createdAt;
  final Value<int> rowid;
  const IngredientPicturesCompanion({
    this.id = const Value.absent(),
  ...
  IngredientPicturesCompanion.insert({
    required String id,
    ...
    this.rowid = const Value.absent(),
       ...
       sortOrder = Value(sortOrder),
       createdAt = Value(createdAt);
  static Insertable<IngredientPicture> custom({
    Expression<String>? id,
  ...
  IngredientPicturesCompanion copyWith({
    Value<String>? id,
  ...
  @override
  String toString() {
    return (StringBuffer('IngredientPicturesCompanion(')
          ..write('id: $id, ')
          ..write('ingredientId: $ingredientId, ')
          ..write('imagePath: $imagePath, ')
          ..write('sortOrder: $sortOrder, ')
...
class $IngredientPricesTable extends IngredientPrices
    with TableInfo<$IngredientPricesTable, IngredientPrice> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $IngredientPricesTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  static const VerificationMeta _packageGramsMeta = const VerificationMeta(
    'packageGrams',
  );
  @override
  late final GeneratedColumn<double> packageGrams = GeneratedColumn<double>(
    'package_grams',
    aliasedName,
    true,
    type: DriftSqlType.double,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'ingredient_prices';
  @override
  VerificationContext validateIntegrity(
    Insertable<IngredientPrice> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('package_grams')) {
      context.handle(
        _packageGramsMeta,
        packageGrams.isAcceptableOrUnknown(
          data['package_grams']!,
          _packageGramsMeta,
        ),
      );
  ...
  @override
  IngredientPrice map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return IngredientPrice(
      ...
      packageGrams: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}package_grams'],
      ),
  ...
  @override
  $IngredientPricesTable createAlias(String alias) {
    return $IngredientPricesTable(attachedDatabase, alias);
  }
}

class IngredientPrice extends DataClass implements Insertable<IngredientPrice> {
  final String id;
  final String ingredientId;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || packageGrams != null) {
      map['package_grams'] = Variable<double>(packageGrams);
    }
  ...
  IngredientPricesCompanion toCompanion(bool nullToAbsent) {
    return IngredientPricesCompanion(
      id: Value(id),
      ingredientId: Value(ingredientId),
      storeId: Value(storeId),
      price: Value(price),
      currencyCode: Value(currencyCode),
      packageGrams: packageGrams == null && nullToAbsent
          ? const Value.absent()
          : Value(packageGrams),
  ...
  factory IngredientPrice.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return IngredientPrice(
      ...
      packageGrams: serializer.fromJson<double?>(json['packageGrams']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'packageGrams': serializer.toJson<double?>(packageGrams),
  ...
  IngredientPrice copyWith({
    ...
    double? price,
    String? currencyCode,
    Value<double?> packageGrams = const Value.absent(),
    int? recordedAt,
    int? createdAt,
  }) => IngredientPrice(
    id: id ?? this.id,
    ...
    packageGrams: packageGrams.present ? packageGrams.value : this.packageGrams,
    recordedAt: recordedAt ?? this.recordedAt,
    createdAt: createdAt ?? this.createdAt,
  );
  IngredientPrice copyWithCompanion(IngredientPricesCompanion data) {
    return IngredientPrice(
      id: data.id.present ? data.id.value : this.id,
      ingredientId: data.ingredientId.present
          ? data.ingredientId.value
      ...
      currencyCode: data.currencyCode.present
          ...
          : this.currencyCode,
      packageGrams: data.packageGrams.present
          ? data.packageGrams.value
          : this.packageGrams,
  ...
  @override
  String toString() {
    return (StringBuffer('IngredientPrice(')
          ..write('id: $id, ')
          ..write('ingredientId: $ingredientId, ')
          ..write('storeId: $storeId, ')
          ..write('price: $price, ')
          ..write('currencyCode: $currencyCode, ')
          ..write('packageGrams: $packageGrams, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is IngredientPrice &&
          ...
          other.packageGrams == this.packageGrams &&
          other.recordedAt == this.recordedAt &&
          other.createdAt == this.createdAt);
}

class IngredientPricesCompanion extends UpdateCompanion<IngredientPrice> {
  final Value<String> id;
  final Value<String> ingredientId;
  final Value<String> storeId;
  final Value<double> price;
  final Value<String> currencyCode;
  final Value<double?> packageGrams;
  final Value<int> recordedAt;
  final Value<int> createdAt;
  final Value<int> rowid;
  const IngredientPricesCompanion({
    this.id = const Value.absent(),
    this.ingredientId = const Value.absent(),
    this.storeId = const Value.absent(),
    this.price = const Value.absent(),
    this.currencyCode = const Value.absent(),
    this.packageGrams = const Value.absent(),
    this.recordedAt = const Value.absent(),
    this.createdAt = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  IngredientPricesCompanion.insert({
    required String id,
    required String ingredientId,
    ...
    this.rowid = const Value.absent(),
       ...
       recordedAt = Value(recordedAt),
       createdAt = Value(createdAt);
  static Insertable<IngredientPrice> custom({
    Expression<String>? id,
    Expression<String>? ingredientId,
    Expression<String>? storeId,
    Expression<double>? price,
    Expression<String>? currencyCode,
    Expression<double>? packageGrams,
    ...
    return RawValuesInsertable({
      ...
      if (packageGrams != null) 'package_grams': packageGrams,
  ...
  IngredientPricesCompanion copyWith({
    Value<String>? id,
    Value<String>? ingredientId,
    Value<String>? storeId,
    Value<double>? price,
    Value<String>? currencyCode,
    Value<double?>? packageGrams,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (packageGrams.present) {
      map['package_grams'] = Variable<double>(packageGrams.value);
    }
  ...
  @override
  String toString() {
    return (StringBuffer('IngredientPricesCompanion(')
          ..write('id: $id, ')
          ..write('ingredientId: $ingredientId, ')
          ..write('storeId: $storeId, ')
          ..write('price: $price, ')
...
class $WorkoutTemplatesTable extends WorkoutTemplates
  ...
  static const VerificationMeta _excludedDatesMeta = const VerificationMeta(
    'excludedDates',
  );
  @override
  late final GeneratedColumn<String> excludedDates = GeneratedColumn<String>(
    'excluded_dates',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('excluded_dates')) {
      context.handle(
        _excludedDatesMeta,
        excludedDates.isAcceptableOrUnknown(
          data['excluded_dates']!,
          _excludedDatesMeta,
        ),
      );
  ...
  WorkoutTemplate map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return WorkoutTemplate(
      ...
      excludedDates: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}excluded_dates'],
      ),
...
class WorkoutTemplate extends DataClass implements Insertable<WorkoutTemplate> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || excludedDates != null) {
      map['excluded_dates'] = Variable<String>(excludedDates);
    }
  ...
  WorkoutTemplatesCompanion toCompanion(bool nullToAbsent) {
    return WorkoutTemplatesCompanion(
      ...
      recurrence: recurrence == null && nullToAbsent
          ? const Value.absent()
          : Value(recurrence),
      excludedDates: excludedDates == null && nullToAbsent
          ? const Value.absent()
          : Value(excludedDates),
  ...
  factory WorkoutTemplate.fromJson(
    ...
    return WorkoutTemplate(
      ...
      excludedDates: serializer.fromJson<String?>(json['excludedDates']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'excludedDates': serializer.toJson<String?>(excludedDates),
  ...
  WorkoutTemplate copyWith({
    ...
    Value<String?> excludedDates = const Value.absent(),
    ...
    excludedDates: excludedDates.present
        ? excludedDates.value
        : this.excludedDates,
  ...
  WorkoutTemplate copyWithCompanion(WorkoutTemplatesCompanion data) {
    return WorkoutTemplate(
      ...
      recurrence: data.recurrence.present
          ...
          : this.recurrence,
      excludedDates: data.excludedDates.present
          ? data.excludedDates.value
          : this.excludedDates,
  ...
  String toString() {
    return (StringBuffer('WorkoutTemplate(')
          ...
          ..write('excludedDates: $excludedDates, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is WorkoutTemplate &&
          ...
          other.excludedDates == this.excludedDates &&
...
class WorkoutTemplatesCompanion extends UpdateCompanion<WorkoutTemplate> {
  ...
  final Value<String?> excludedDates;
  ...
  const WorkoutTemplatesCompanion({
    ...
    this.excludedDates = const Value.absent(),
  ...
  static Insertable<WorkoutTemplate> custom({
    ...
    Expression<String>? excludedDates,
    ...
    return RawValuesInsertable({
      ...
      if (excludedDates != null) 'excluded_dates': excludedDates,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (excludedDates.present) {
      map['excluded_dates'] = Variable<String>(excludedDates.value);
    }
...
class WorkoutTemplateExercise extends DataClass
  ...
  @override
  int get hashCode => Object.hash(id, templateId, exerciseId, sortOrder, notes);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $WorkoutTemplateSetsTable extends WorkoutTemplateSets
    with TableInfo<$WorkoutTemplateSetsTable, WorkoutTemplateSet> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $WorkoutTemplateSetsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'workout_template_sets';
  @override
  VerificationContext validateIntegrity(
    Insertable<WorkoutTemplateSet> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  WorkoutTemplateSet map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $WorkoutTemplateSetsTable createAlias(String alias) {
    return $WorkoutTemplateSetsTable(attachedDatabase, alias);
  }
}

class WorkoutTemplateSet extends DataClass
    implements Insertable<WorkoutTemplateSet> {
  final String id;
  ...
  WorkoutTemplateSetsCompanion toCompanion(bool nullToAbsent) {
    return WorkoutTemplateSetsCompanion(
      id: Value(id),
  ...
  factory WorkoutTemplateSet.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  WorkoutTemplateSet copyWithCompanion(WorkoutTemplateSetsCompanion data) {
    return WorkoutTemplateSet(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('WorkoutTemplateSet(')
          ..write('id: $id, ')
...
class WorkoutTemplateSetsCompanion extends UpdateCompanion<WorkoutTemplateSet> {
  final Value<String> id;
  ...
  final Value<double?> distanceMeters;
  final Value<int> rowid;
  const WorkoutTemplateSetsCompanion({
    this.id = const Value.absent(),
  ...
  WorkoutTemplateSetsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       templateExerciseId = Value(templateExerciseId),
       setNumber = Value(setNumber);
  static Insertable<WorkoutTemplateSet> custom({
    Expression<String>? id,
  ...
  WorkoutTemplateSetsCompanion copyWith({
    Value<String>? id,
  ...
  @override
  String toString() {
    return (StringBuffer('WorkoutTemplateSetsCompanion(')
          ..write('id: $id, ')
          ..write('templateExerciseId: $templateExerciseId, ')
          ..write('setNumber: $setNumber, ')
          ..write('reps: $reps, ')
...
class $FxRatesTable extends FxRates with TableInfo<$FxRatesTable, FxRate> {
  ...
  late final GeneratedColumn<String> rateDate = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    defaultValue: const Constant('0001-01-01'),
  );
  @override
  List<GeneratedColumn> get $columns => [
    code,
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {code, baseCode, rateDate};
  @override
...
class FxRate extends DataClass implements Insertable<FxRate> {
  ...
  @override
  int get hashCode =>
      Object.hash(code, rateToBase, baseCode, updatedAt, manual, rateDate);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is FxRate &&
...
class $GoalProgressEntriesTable extends GoalProgressEntries
    with TableInfo<$GoalProgressEntriesTable, GoalProgressEntry> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<GoalProgressEntry> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  GoalProgressEntry map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
...
class GoalProgressEntry extends DataClass
    implements Insertable<GoalProgressEntry> {
  final String id;
  final String goalId;
  final int recordedAt;
  final double value;
  ...
  factory GoalProgressEntry.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  GoalProgressEntry copyWithCompanion(GoalProgressEntriesCompanion data) {
    return GoalProgressEntry(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('GoalProgressEntry(')
          ..write('id: $id, ')
          ..write('goalId: $goalId, ')
          ..write('recordedAt: $recordedAt, ')
          ..write('value: $value, ')
  ...
  @override
  int get hashCode =>
      Object.hash(id, goalId, recordedAt, value, note, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is GoalProgressEntry &&
          other.id == this.id &&
...
class GoalProgressEntriesCompanion extends UpdateCompanion<GoalProgressEntry> {
  final Value<String> id;
  ...
  GoalProgressEntriesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       value = Value(value),
       createdAt = Value(createdAt);
  static Insertable<GoalProgressEntry> custom({
    Expression<String>? id,
...
class $TaskExperimentsTable extends TaskExperiments
    with TableInfo<$TaskExperimentsTable, TaskExperiment> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $TaskExperimentsTable(this.attachedDatabase, [this._alias]);
  ...
  @override
  List<GeneratedColumn> get $columns => [taskId, experimentId, label];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'task_experiments';
  @override
  VerificationContext validateIntegrity(
    Insertable<TaskExperiment> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {taskId, experimentId};
  @override
  TaskExperiment map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $TaskExperimentsTable createAlias(String alias) {
    return $TaskExperimentsTable(attachedDatabase, alias);
  }
}

class TaskExperiment extends DataClass implements Insertable<TaskExperiment> {
  final String taskId;
  final String experimentId;

  /// Optional relationship label ('supports', 'measures', …).
  final String? label;
  const TaskExperiment({
  ...
  TaskExperimentsCompanion toCompanion(bool nullToAbsent) {
    return TaskExperimentsCompanion(
      taskId: Value(taskId),
      experimentId: Value(experimentId),
  ...
  factory TaskExperiment.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  TaskExperiment copyWithCompanion(TaskExperimentsCompanion data) {
    return TaskExperiment(
  ...
  @override
  String toString() {
    return (StringBuffer('TaskExperiment(')
          ..write('taskId: $taskId, ')
          ..write('experimentId: $experimentId, ')
          ..write('label: $label')
          ..write(')'))
  ...
  @override
  int get hashCode => Object.hash(taskId, experimentId, label);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is TaskExperiment &&
          other.taskId == this.taskId &&
          other.experimentId == this.experimentId &&
          other.label == this.label);
}

class TaskExperimentsCompanion extends UpdateCompanion<TaskExperiment> {
  final Value<String> taskId;
  final Value<String> experimentId;
  final Value<String?> label;
  final Value<int> rowid;
  const TaskExperimentsCompanion({
    this.taskId = const Value.absent(),
    this.experimentId = const Value.absent(),
    this.label = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  TaskExperimentsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       experimentId = Value(experimentId);
  static Insertable<TaskExperiment> custom({
  ...
  TaskExperimentsCompanion copyWith({
    Value<String>? taskId,
    Value<String>? experimentId,
    Value<String?>? label,
    Value<int>? rowid,
  ...
  @override
  String toString() {
    return (StringBuffer('TaskExperimentsCompanion(')
          ..write('taskId: $taskId, ')
          ..write('experimentId: $experimentId, ')
          ..write('label: $label, ')
          ..write('rowid: $rowid')
...
class $TaskGoalsTable extends TaskGoals
    with TableInfo<$TaskGoalsTable, TaskGoal> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $TaskGoalsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _taskIdMeta = const VerificationMeta('taskId');
  @override
  late final GeneratedColumn<String> taskId = GeneratedColumn<String>(
    'task_id',
  ...
  @override
  List<GeneratedColumn> get $columns => [taskId, goalId, label];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'task_goals';
  @override
  VerificationContext validateIntegrity(
    Insertable<TaskGoal> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {taskId, goalId};
  @override
  TaskGoal map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TaskGoal(
      taskId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
  ...
  @override
  $TaskGoalsTable createAlias(String alias) {
    return $TaskGoalsTable(attachedDatabase, alias);
  }
}

class TaskGoal extends DataClass implements Insertable<TaskGoal> {
  final String taskId;
  final String goalId;
  final String? label;
  const TaskGoal({required this.taskId, required this.goalId, this.label});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['task_id'] = Variable<String>(taskId);
  ...
  TaskGoalsCompanion toCompanion(bool nullToAbsent) {
    return TaskGoalsCompanion(
      taskId: Value(taskId),
      goalId: Value(goalId),
      label: label == null && nullToAbsent
          ? const Value.absent()
  ...
  TaskGoal copyWithCompanion(TaskGoalsCompanion data) {
    return TaskGoal(
      taskId: data.taskId.present ? data.taskId.value : this.taskId,
      goalId: data.goalId.present ? data.goalId.value : this.goalId,
      label: data.label.present ? data.label.value : this.label,
  ...
  @override
  int get hashCode => Object.hash(taskId, goalId, label);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is TaskGoal &&
...
class TaskGoalsCompanion extends UpdateCompanion<TaskGoal> {
  final Value<String> taskId;
  final Value<String> goalId;
  final Value<String?> label;
  final Value<int> rowid;
  const TaskGoalsCompanion({
    this.taskId = const Value.absent(),
    this.goalId = const Value.absent(),
    this.label = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  TaskGoalsCompanion.insert({
    required String taskId,
    required String goalId,
    this.label = const Value.absent(),
    this.rowid = const Value.absent(),
       ...
       goalId = Value(goalId);
  static Insertable<TaskGoal> custom({
    Expression<String>? taskId,
    Expression<String>? goalId,
    Expression<String>? label,
    Expression<int>? rowid,
  ...
  @override
  String toString() {
    return (StringBuffer('TaskGoalsCompanion(')
          ..write('taskId: $taskId, ')
          ..write('goalId: $goalId, ')
          ..write('label: $label, ')
          ..write('rowid: $rowid')
...
class $ExperimentGoalsTable extends ExperimentGoals
    with TableInfo<$ExperimentGoalsTable, ExperimentGoal> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ExperimentGoalsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _experimentIdMeta = const VerificationMeta(
    'experimentId',
  );
  @override
  ...
  @override
  List<GeneratedColumn> get $columns => [experimentId, goalId, label];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'experiment_goals';
  @override
  VerificationContext validateIntegrity(
    Insertable<ExperimentGoal> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {experimentId, goalId};
  @override
  ExperimentGoal map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $ExperimentGoalsTable createAlias(String alias) {
    return $ExperimentGoalsTable(attachedDatabase, alias);
  }
}

class ExperimentGoal extends DataClass implements Insertable<ExperimentGoal> {
  final String experimentId;
  final String goalId;
  final String? label;
  ...
  ExperimentGoalsCompanion toCompanion(bool nullToAbsent) {
    return ExperimentGoalsCompanion(
      experimentId: Value(experimentId),
      goalId: Value(goalId),
      label: label == null && nullToAbsent
          ? const Value.absent()
  ...
  factory ExperimentGoal.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  ExperimentGoal copyWithCompanion(ExperimentGoalsCompanion data) {
    return ExperimentGoal(
      experimentId: data.experimentId.present
          ? data.experimentId.value
          : this.experimentId,
  ...
  @override
  String toString() {
    return (StringBuffer('ExperimentGoal(')
          ..write('experimentId: $experimentId, ')
          ..write('goalId: $goalId, ')
          ..write('label: $label')
          ..write(')'))
  ...
  @override
  int get hashCode => Object.hash(experimentId, goalId, label);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ExperimentGoal &&
          other.experimentId == this.experimentId &&
          other.goalId == this.goalId &&
          other.label == this.label);
}

class ExperimentGoalsCompanion extends UpdateCompanion<ExperimentGoal> {
  final Value<String> experimentId;
  final Value<String> goalId;
  final Value<String?> label;
  final Value<int> rowid;
  const ExperimentGoalsCompanion({
    this.experimentId = const Value.absent(),
    this.goalId = const Value.absent(),
    this.label = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  ExperimentGoalsCompanion.insert({
    required String experimentId,
    required String goalId,
    this.label = const Value.absent(),
    this.rowid = const Value.absent(),
       ...
       goalId = Value(goalId);
  static Insertable<ExperimentGoal> custom({
    Expression<String>? experimentId,
    Expression<String>? goalId,
    Expression<String>? label,
    Expression<int>? rowid,
  ...
  ExperimentGoalsCompanion copyWith({
    Value<String>? experimentId,
    Value<String>? goalId,
    Value<String?>? label,
    Value<int>? rowid,
  ...
  @override
  String toString() {
    return (StringBuffer('ExperimentGoalsCompanion(')
          ..write('experimentId: $experimentId, ')
          ..write('goalId: $goalId, ')
          ..write('label: $label, ')
          ..write('rowid: $rowid')
...
class $TaskNotesTable extends TaskNotes
  ...
  @override
  List<GeneratedColumn> get $columns => [taskId, noteId, label];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {taskId, noteId};
  @override
...
class TaskNote extends DataClass implements Insertable<TaskNote> {
  ...
  final String noteId;
  final String? label;
  const TaskNote({required this.taskId, required this.noteId, this.label});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['task_id'] = Variable<String>(taskId);
  ...
  @override
  int get hashCode => Object.hash(taskId, noteId, label);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is TaskNote &&
...
class $ExperimentNotesTable extends ExperimentNotes
    with TableInfo<$ExperimentNotesTable, ExperimentNote> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ExperimentNotesTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _experimentIdMeta = const VerificationMeta(
    'experimentId',
  );
  @override
  ...
  @override
  List<GeneratedColumn> get $columns => [experimentId, noteId, label];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'experiment_notes';
  @override
  VerificationContext validateIntegrity(
    Insertable<ExperimentNote> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {experimentId, noteId};
  @override
  ExperimentNote map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $ExperimentNotesTable createAlias(String alias) {
    return $ExperimentNotesTable(attachedDatabase, alias);
  }
}

class ExperimentNote extends DataClass implements Insertable<ExperimentNote> {
  final String experimentId;
  final String noteId;
  final String? label;
  ...
  ExperimentNotesCompanion toCompanion(bool nullToAbsent) {
    return ExperimentNotesCompanion(
      experimentId: Value(experimentId),
      noteId: Value(noteId),
      label: label == null && nullToAbsent
          ? const Value.absent()
  ...
  factory ExperimentNote.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  ExperimentNote copyWithCompanion(ExperimentNotesCompanion data) {
    return ExperimentNote(
      experimentId: data.experimentId.present
          ? data.experimentId.value
          : this.experimentId,
  ...
  @override
  String toString() {
    return (StringBuffer('ExperimentNote(')
          ..write('experimentId: $experimentId, ')
          ..write('noteId: $noteId, ')
          ..write('label: $label')
          ..write(')'))
  ...
  @override
  int get hashCode => Object.hash(experimentId, noteId, label);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ExperimentNote &&
          other.experimentId == this.experimentId &&
          other.noteId == this.noteId &&
          other.label == this.label);
}

class ExperimentNotesCompanion extends UpdateCompanion<ExperimentNote> {
  final Value<String> experimentId;
  final Value<String> noteId;
  final Value<String?> label;
  final Value<int> rowid;
  const ExperimentNotesCompanion({
    this.experimentId = const Value.absent(),
    this.noteId = const Value.absent(),
    this.label = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  ExperimentNotesCompanion.insert({
    required String experimentId,
    required String noteId,
    this.label = const Value.absent(),
    this.rowid = const Value.absent(),
       ...
       noteId = Value(noteId);
  static Insertable<ExperimentNote> custom({
    Expression<String>? experimentId,
    Expression<String>? noteId,
    Expression<String>? label,
    Expression<int>? rowid,
  ...
  ExperimentNotesCompanion copyWith({
    Value<String>? experimentId,
    Value<String>? noteId,
    Value<String?>? label,
    Value<int>? rowid,
  ...
  @override
  String toString() {
    return (StringBuffer('ExperimentNotesCompanion(')
          ..write('experimentId: $experimentId, ')
          ..write('noteId: $noteId, ')
          ..write('label: $label, ')
          ..write('rowid: $rowid')
...
class $GoalNotesTable extends GoalNotes
    with TableInfo<$GoalNotesTable, GoalNote> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $GoalNotesTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _goalIdMeta = const VerificationMeta('goalId');
  @override
  late final GeneratedColumn<String> goalId = GeneratedColumn<String>(
    'goal_id',
  ...
  @override
  List<GeneratedColumn> get $columns => [goalId, noteId, label];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'goal_notes';
  @override
  VerificationContext validateIntegrity(
    Insertable<GoalNote> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {goalId, noteId};
  @override
  GoalNote map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return GoalNote(
      goalId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
  ...
  @override
  $GoalNotesTable createAlias(String alias) {
    return $GoalNotesTable(attachedDatabase, alias);
  }
}

class GoalNote extends DataClass implements Insertable<GoalNote> {
  final String goalId;
  final String noteId;
  final String? label;
  const GoalNote({required this.goalId, required this.noteId, this.label});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['goal_id'] = Variable<String>(goalId);
  ...
  GoalNotesCompanion toCompanion(bool nullToAbsent) {
    return GoalNotesCompanion(
      goalId: Value(goalId),
      noteId: Value(noteId),
      label: label == null && nullToAbsent
          ? const Value.absent()
  ...
  GoalNote copyWithCompanion(GoalNotesCompanion data) {
    return GoalNote(
      goalId: data.goalId.present ? data.goalId.value : this.goalId,
      noteId: data.noteId.present ? data.noteId.value : this.noteId,
      label: data.label.present ? data.label.value : this.label,
  ...
  @override
  int get hashCode => Object.hash(goalId, noteId, label);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is GoalNote &&
...
class GoalNotesCompanion extends UpdateCompanion<GoalNote> {
  final Value<String> goalId;
  final Value<String> noteId;
  final Value<String?> label;
  final Value<int> rowid;
  const GoalNotesCompanion({
    this.goalId = const Value.absent(),
    this.noteId = const Value.absent(),
    this.label = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  GoalNotesCompanion.insert({
    required String goalId,
    required String noteId,
    this.label = const Value.absent(),
    this.rowid = const Value.absent(),
       ...
       noteId = Value(noteId);
  static Insertable<GoalNote> custom({
    Expression<String>? goalId,
    Expression<String>? noteId,
    Expression<String>? label,
    Expression<int>? rowid,
  ...
  @override
  String toString() {
    return (StringBuffer('GoalNotesCompanion(')
          ..write('goalId: $goalId, ')
          ..write('noteId: $noteId, ')
          ..write('label: $label, ')
          ..write('rowid: $rowid')
...
class $GoalWorkoutsTable extends GoalWorkouts
    with TableInfo<$GoalWorkoutsTable, GoalWorkout> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $GoalWorkoutsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _goalIdMeta = const VerificationMeta('goalId');
  @override
  late final GeneratedColumn<String> goalId = GeneratedColumn<String>(
    'goal_id',
  ...
  @override
  List<GeneratedColumn> get $columns => [goalId, workoutId, label];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'goal_workouts';
  @override
  VerificationContext validateIntegrity(
    Insertable<GoalWorkout> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {goalId, workoutId};
  @override
  GoalWorkout map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return GoalWorkout(
      goalId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
  ...
  @override
  $GoalWorkoutsTable createAlias(String alias) {
    return $GoalWorkoutsTable(attachedDatabase, alias);
  }
}

class GoalWorkout extends DataClass implements Insertable<GoalWorkout> {
  final String goalId;
  final String workoutId;
  final String? label;
  const GoalWorkout({
  ...
  GoalWorkoutsCompanion toCompanion(bool nullToAbsent) {
    return GoalWorkoutsCompanion(
      goalId: Value(goalId),
      workoutId: Value(workoutId),
      label: label == null && nullToAbsent
          ? const Value.absent()
  ...
  GoalWorkout copyWithCompanion(GoalWorkoutsCompanion data) {
    return GoalWorkout(
      goalId: data.goalId.present ? data.goalId.value : this.goalId,
      workoutId: data.workoutId.present ? data.workoutId.value : this.workoutId,
      label: data.label.present ? data.label.value : this.label,
  ...
  @override
  String toString() {
    return (StringBuffer('GoalWorkout(')
          ..write('goalId: $goalId, ')
          ..write('workoutId: $workoutId, ')
          ..write('label: $label')
          ..write(')'))
  ...
  @override
  int get hashCode => Object.hash(goalId, workoutId, label);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is GoalWorkout &&
          other.goalId == this.goalId &&
          other.workoutId == this.workoutId &&
          other.label == this.label);
}

class GoalWorkoutsCompanion extends UpdateCompanion<GoalWorkout> {
  final Value<String> goalId;
  final Value<String> workoutId;
  final Value<String?> label;
  final Value<int> rowid;
  const GoalWorkoutsCompanion({
    this.goalId = const Value.absent(),
    this.workoutId = const Value.absent(),
    this.label = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  GoalWorkoutsCompanion.insert({
    required String goalId,
    required String workoutId,
    this.label = const Value.absent(),
    this.rowid = const Value.absent(),
       ...
       workoutId = Value(workoutId);
  static Insertable<GoalWorkout> custom({
    Expression<String>? goalId,
    Expression<String>? workoutId,
    Expression<String>? label,
    Expression<int>? rowid,
  ...
  GoalWorkoutsCompanion copyWith({
    Value<String>? goalId,
    Value<String>? workoutId,
    Value<String?>? label,
    Value<int>? rowid,
  ...
  @override
  String toString() {
    return (StringBuffer('GoalWorkoutsCompanion(')
          ..write('goalId: $goalId, ')
          ..write('workoutId: $workoutId, ')
          ..write('label: $label, ')
          ..write('rowid: $rowid')
...
class $NoteWorkoutsTable extends NoteWorkouts
    with TableInfo<$NoteWorkoutsTable, NoteWorkout> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $NoteWorkoutsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _noteIdMeta = const VerificationMeta('noteId');
  @override
  late final GeneratedColumn<String> noteId = GeneratedColumn<String>(
    'note_id',
  ...
  @override
  List<GeneratedColumn> get $columns => [noteId, workoutId, label];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'note_workouts';
  @override
  VerificationContext validateIntegrity(
    Insertable<NoteWorkout> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {noteId, workoutId};
  @override
  NoteWorkout map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return NoteWorkout(
      noteId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
  ...
  @override
  $NoteWorkoutsTable createAlias(String alias) {
    return $NoteWorkoutsTable(attachedDatabase, alias);
  }
}

class NoteWorkout extends DataClass implements Insertable<NoteWorkout> {
  final String noteId;
  final String workoutId;
  final String? label;
  const NoteWorkout({
  ...
  NoteWorkoutsCompanion toCompanion(bool nullToAbsent) {
    return NoteWorkoutsCompanion(
      noteId: Value(noteId),
      workoutId: Value(workoutId),
      label: label == null && nullToAbsent
          ? const Value.absent()
  ...
  NoteWorkout copyWithCompanion(NoteWorkoutsCompanion data) {
    return NoteWorkout(
      noteId: data.noteId.present ? data.noteId.value : this.noteId,
      workoutId: data.workoutId.present ? data.workoutId.value : this.workoutId,
      label: data.label.present ? data.label.value : this.label,
  ...
  @override
  String toString() {
    return (StringBuffer('NoteWorkout(')
          ..write('noteId: $noteId, ')
          ..write('workoutId: $workoutId, ')
          ..write('label: $label')
          ..write(')'))
  ...
  @override
  int get hashCode => Object.hash(noteId, workoutId, label);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is NoteWorkout &&
          other.noteId == this.noteId &&
          other.workoutId == this.workoutId &&
          other.label == this.label);
}

class NoteWorkoutsCompanion extends UpdateCompanion<NoteWorkout> {
  final Value<String> noteId;
  final Value<String> workoutId;
  final Value<String?> label;
  final Value<int> rowid;
  const NoteWorkoutsCompanion({
    this.noteId = const Value.absent(),
    this.workoutId = const Value.absent(),
    this.label = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  NoteWorkoutsCompanion.insert({
    required String noteId,
    required String workoutId,
    this.label = const Value.absent(),
    this.rowid = const Value.absent(),
       ...
       workoutId = Value(workoutId);
  static Insertable<NoteWorkout> custom({
    Expression<String>? noteId,
    Expression<String>? workoutId,
    Expression<String>? label,
    Expression<int>? rowid,
  ...
  NoteWorkoutsCompanion copyWith({
    Value<String>? noteId,
    Value<String>? workoutId,
    Value<String?>? label,
    Value<int>? rowid,
  ...
  @override
  String toString() {
    return (StringBuffer('NoteWorkoutsCompanion(')
          ..write('noteId: $noteId, ')
          ..write('workoutId: $workoutId, ')
          ..write('label: $label, ')
          ..write('rowid: $rowid')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $IngredientPicturesTable ingredientPictures =
      $IngredientPicturesTable(this);
  ...
  late final $WorkoutTemplateSetsTable workoutTemplateSets =
      $WorkoutTemplateSetsTable(this);
  ...
  late final $TaskExperimentsTable taskExperiments = $TaskExperimentsTable(
    this,
  );
  late final $TaskGoalsTable taskGoals = $TaskGoalsTable(this);
  late final $ExperimentGoalsTable experimentGoals = $ExperimentGoalsTable(
    this,
  );
  late final $TaskNotesTable taskNotes = $TaskNotesTable(this);
  late final $ExperimentNotesTable experimentNotes = $ExperimentNotesTable(
    this,
  );
...
final class $$IngredientsTableReferences
  ...
  static MultiTypedResultKey<$IngredientPicturesTable, List<IngredientPicture>>
  _ingredientPicturesRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.ingredientPictures,
        aliasName: $_aliasNameGenerator(
          db.ingredients.id,
          db.ingredientPictures.ingredientId,
        ),
      );

  $$IngredientPicturesTableProcessedTableManager get ingredientPicturesRefs {
    final manager = $$IngredientPicturesTableTableManager(
      $_db,
      $_db.ingredientPictures,
    ).filter((f) => f.ingredientId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _ingredientPicturesRefsTable($_db),
    );
  ...
  static MultiTypedResultKey<$IngredientPricesTable, List<IngredientPrice>>
  _ingredientPricesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.ingredientPrices,
    aliasName: $_aliasNameGenerator(
      db.ingredients.id,
      db.ingredientPrices.ingredientId,
    ),
  );

  $$IngredientPricesTableProcessedTableManager get ingredientPricesRefs {
    final manager = $$IngredientPricesTableTableManager(
      $_db,
      $_db.ingredientPrices,
    ).filter((f) => f.ingredientId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _ingredientPricesRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
...
class $$IngredientsTableFilterComposer
  ...
  Expression<bool> ingredientPicturesRefs(
    Expression<bool> Function($$IngredientPicturesTableFilterComposer f) f,
  ) {
    final $$IngredientPicturesTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.ingredientPictures,
      ...
      builder:
          ...
          }) => $$IngredientPicturesTableFilterComposer(
            $db: $db,
            $table: $db.ingredientPictures,
  ...
  Expression<bool> ingredientPricesRefs(
    Expression<bool> Function($$IngredientPricesTableFilterComposer f) f,
  ) {
    final $$IngredientPricesTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.ingredientPrices,
      getReferencedColumn: (t) => t.ingredientId,
      builder:
          (
            joinBuilder, {
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$IngredientPricesTableFilterComposer(
            $db: $db,
            $table: $db.ingredientPrices,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
            $removeJoinBuilderFromRootComposer:
                $removeJoinBuilderFromRootComposer,
...
class $$IngredientsTableAnnotationComposer
  ...
  Expression<T> ingredientPicturesRefs<T extends Object>(
    Expression<T> Function($$IngredientPicturesTableAnnotationComposer a) f,
  ) {
    final $$IngredientPicturesTableAnnotationComposer composer =
        $composerBuilder(
          composer: this,
          getCurrentColumn: (t) => t.id,
          referencedTable: $db.ingredientPictures,
          ...
          builder:
              (
                ...
                $addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer,
              }) => $$IngredientPicturesTableAnnotationComposer(
                $db: $db,
                $table: $db.ingredientPictures,
                $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
                joinBuilder: joinBuilder,
  ...
  Expression<T> ingredientPricesRefs<T extends Object>(
    Expression<T> Function($$IngredientPricesTableAnnotationComposer a) f,
  ) {
    final $$IngredientPricesTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.ingredientPrices,
      getReferencedColumn: (t) => t.ingredientId,
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$IngredientPricesTableAnnotationComposer(
            $db: $db,
            $table: $db.ingredientPrices,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
                    ...
                    return [
                      if (ingredientPicturesRefs)
                        ...
                        >(
                          ...
                          referencedTable: $$IngredientsTableReferences
                              ._ingredientPicturesRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$IngredientsTableReferences(
                                db,
                                table,
                                p0,
                              ).ingredientPicturesRefs,
                      ...
                      if (ingredientPricesRefs)
                        ...
                        >(
                          currentTable: table,
                          referencedTable: $$IngredientsTableReferences
                              ._ingredientPricesRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$IngredientsTableReferences(
                                db,
                                table,
                                p0,
                              ).ingredientPricesRefs,
                          referencedItemsForCurrentItem:
                              (item, referencedItems) => referencedItems.where(
                                (e) => e.ingredientId == item.id,
                              ),
...
final class $$StoresTableReferences
  ...
  _ingredientPricesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.ingredientPrices,
    aliasName: $_aliasNameGenerator(db.stores.id, db.ingredientPrices.storeId),
  );
...
class $$StoresTableTableManager
    extends
        RootTableManager<
          ...
          Store,
          PrefetchHooks Function({bool ingredientPricesRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({ingredientPricesRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [
                if (ingredientPricesRefs) db.ingredientPrices,
...
typedef $$StoresTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool ingredientPricesRefs})
    >;
typedef $$IngredientPicturesTableCreateCompanionBuilder =
    IngredientPicturesCompanion Function({
      required String id,
      required String ingredientId,
      required String imagePath,
      required int sortOrder,
...
typedef $$IngredientPicturesTableUpdateCompanionBuilder =
    IngredientPicturesCompanion Function({
      Value<String> id,
      Value<String> ingredientId,
      Value<String> imagePath,
...
final class $$IngredientPicturesTableReferences
    extends
        BaseReferences<
          _$AppDatabase,
          $IngredientPicturesTable,
          IngredientPicture
        > {
  $$IngredientPicturesTableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );
...
class $$IngredientPicturesTableFilterComposer
    extends Composer<_$AppDatabase, $IngredientPicturesTable> {
  $$IngredientPicturesTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$IngredientPicturesTableOrderingComposer
    extends Composer<_$AppDatabase, $IngredientPicturesTable> {
  $$IngredientPicturesTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$IngredientPicturesTableAnnotationComposer
    extends Composer<_$AppDatabase, $IngredientPicturesTable> {
  $$IngredientPicturesTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$IngredientPicturesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $IngredientPicturesTable,
          ...
          $$IngredientPicturesTableOrderingComposer,
          $$IngredientPicturesTableAnnotationComposer,
          $$IngredientPicturesTableCreateCompanionBuilder,
          $$IngredientPicturesTableUpdateCompanionBuilder,
          (IngredientPicture, $$IngredientPicturesTableReferences),
          IngredientPicture,
          PrefetchHooks Function({bool ingredientId})
        > {
  $$IngredientPicturesTableTableManager(
    _$AppDatabase db,
    $IngredientPicturesTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$IngredientPicturesTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$IngredientPicturesTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$IngredientPicturesTableAnnotationComposer(
                $db: db,
                $table: table,
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$IngredientPicturesTableReferences(db, table, e),
                ),
              )
              .toList(),
...
typedef $$IngredientPicturesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $IngredientPicturesTable,
      IngredientPicture,
      ...
      PrefetchHooks Function({bool ingredientId})
    >;
typedef $$IngredientPricesTableCreateCompanionBuilder =
    IngredientPricesCompanion Function({
      required String id,
      required String ingredientId,
      required String storeId,
      required double price,
...
typedef $$IngredientPricesTableUpdateCompanionBuilder =
    IngredientPricesCompanion Function({
      Value<String> id,
      Value<String> ingredientId,
      Value<String> storeId,
...
final class $$IngredientPricesTableReferences
    extends
        BaseReferences<_$AppDatabase, $IngredientPricesTable, IngredientPrice> {
  $$IngredientPricesTableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );
  ...
  static $StoresTable _storeIdTable(_$AppDatabase db) => db.stores.createAlias(
    $_aliasNameGenerator(db.ingredientPrices.storeId, db.stores.id),
  );
...
class $$IngredientPricesTableFilterComposer
    extends Composer<_$AppDatabase, $IngredientPricesTable> {
  $$IngredientPricesTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
  ...
  ColumnFilters<double> get packageGrams => $composableBuilder(
    column: $table.packageGrams,
    builder: (column) => ColumnFilters(column),
  );
...
class $$IngredientPricesTableOrderingComposer
    extends Composer<_$AppDatabase, $IngredientPricesTable> {
  $$IngredientPricesTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnOrderings<double> get packageGrams => $composableBuilder(
    column: $table.packageGrams,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$IngredientPricesTableAnnotationComposer
    extends Composer<_$AppDatabase, $IngredientPricesTable> {
  $$IngredientPricesTableAnnotationComposer({
    required super.$db,
    required super.$table,
  ...
  GeneratedColumn<double> get packageGrams => $composableBuilder(
    column: $table.packageGrams,
    builder: (column) => column,
  );
...
class $$IngredientPricesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          ...
          $$IngredientPricesTableOrderingComposer,
          $$IngredientPricesTableAnnotationComposer,
          $$IngredientPricesTableCreateCompanionBuilder,
          $$IngredientPricesTableUpdateCompanionBuilder,
          (IngredientPrice, $$IngredientPricesTableReferences),
          IngredientPrice,
          PrefetchHooks Function({bool ingredientId, bool storeId})
        > {
  $$IngredientPricesTableTableManager(
    _$AppDatabase db,
    $IngredientPricesTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$IngredientPricesTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$IngredientPricesTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$IngredientPricesTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> id = const Value.absent(),
                Value<String> ingredientId = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$IngredientPricesTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback: ({ingredientId = false, storeId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins:
...
typedef $$IngredientPricesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $IngredientPricesTable,
      IngredientPrice,
...
final class $$WorkoutsTableReferences
  ...
  static MultiTypedResultKey<$GoalWorkoutsTable, List<GoalWorkout>>
  _goalWorkoutsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.goalWorkouts,
    aliasName: $_aliasNameGenerator(db.workouts.id, db.goalWorkouts.workoutId),
  );

  $$GoalWorkoutsTableProcessedTableManager get goalWorkoutsRefs {
    final manager = $$GoalWorkoutsTableTableManager(
      $_db,
      $_db.goalWorkouts,
    ).filter((f) => f.workoutId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(_goalWorkoutsRefsTable($_db));
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  }

  static MultiTypedResultKey<$NoteWorkoutsTable, List<NoteWorkout>>
  _noteWorkoutsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.noteWorkouts,
    aliasName: $_aliasNameGenerator(db.workouts.id, db.noteWorkouts.workoutId),
  );

  $$NoteWorkoutsTableProcessedTableManager get noteWorkoutsRefs {
    final manager = $$NoteWorkoutsTableTableManager(
      $_db,
      $_db.noteWorkouts,
    ).filter((f) => f.workoutId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(_noteWorkoutsRefsTable($_db));
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  }
...
class $$WorkoutsTableFilterComposer
  ...
  Expression<bool> goalWorkoutsRefs(
    Expression<bool> Function($$GoalWorkoutsTableFilterComposer f) f,
  ) {
    final $$GoalWorkoutsTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.goalWorkouts,
      getReferencedColumn: (t) => t.workoutId,
      builder:
          (
            joinBuilder, {
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$GoalWorkoutsTableFilterComposer(
            $db: $db,
            $table: $db.goalWorkouts,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
            $removeJoinBuilderFromRootComposer:
                $removeJoinBuilderFromRootComposer,
  ...
  Expression<bool> noteWorkoutsRefs(
    Expression<bool> Function($$NoteWorkoutsTableFilterComposer f) f,
  ) {
    final $$NoteWorkoutsTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.noteWorkouts,
      getReferencedColumn: (t) => t.workoutId,
      builder:
          (
            joinBuilder, {
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$NoteWorkoutsTableFilterComposer(
            $db: $db,
            $table: $db.noteWorkouts,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
            $removeJoinBuilderFromRootComposer:
                $removeJoinBuilderFromRootComposer,
...
class $$WorkoutsTableAnnotationComposer
  ...
  Expression<T> goalWorkoutsRefs<T extends Object>(
    Expression<T> Function($$GoalWorkoutsTableAnnotationComposer a) f,
  ) {
    final $$GoalWorkoutsTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.goalWorkouts,
      getReferencedColumn: (t) => t.workoutId,
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$GoalWorkoutsTableAnnotationComposer(
            $db: $db,
            $table: $db.goalWorkouts,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
  ...
  Expression<T> noteWorkoutsRefs<T extends Object>(
    Expression<T> Function($$NoteWorkoutsTableAnnotationComposer a) f,
  ) {
    final $$NoteWorkoutsTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.noteWorkouts,
      getReferencedColumn: (t) => t.workoutId,
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$NoteWorkoutsTableAnnotationComposer(
            $db: $db,
            $table: $db.noteWorkouts,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
...
class $$WorkoutTemplatesTableFilterComposer
  ...
  ColumnFilters<String> get excludedDates => $composableBuilder(
    column: $table.excludedDates,
    builder: (column) => ColumnFilters(column),
  );
...
class $$WorkoutTemplatesTableOrderingComposer
  ...
  ColumnOrderings<String> get excludedDates => $composableBuilder(
    column: $table.excludedDates,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$WorkoutTemplatesTableAnnotationComposer
  ...
  GeneratedColumn<String> get excludedDates => $composableBuilder(
    column: $table.excludedDates,
    builder: (column) => column,
  );
...
final class $$WorkoutTemplateExercisesTableReferences
  ...
  static MultiTypedResultKey<
    $WorkoutTemplateSetsTable,
    List<WorkoutTemplateSet>
  >
  _workoutTemplateSetsRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.workoutTemplateSets,
        aliasName: $_aliasNameGenerator(
          db.workoutTemplateExercises.id,
          db.workoutTemplateSets.templateExerciseId,
        ),
      );

  $$WorkoutTemplateSetsTableProcessedTableManager get workoutTemplateSetsRefs {
    final manager =
        $$WorkoutTemplateSetsTableTableManager(
          $_db,
          $_db.workoutTemplateSets,
        ).filter(
          (f) => f.templateExerciseId.id.sqlEquals($_itemColumn<String>('id')!),
        );

    final cache = $_typedResult.readTableOrNull(
      _workoutTemplateSetsRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
...
class $$WorkoutTemplateExercisesTableFilterComposer
  ...
  Expression<bool> workoutTemplateSetsRefs(
    Expression<bool> Function($$WorkoutTemplateSetsTableFilterComposer f) f,
  ) {
    final $$WorkoutTemplateSetsTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.workoutTemplateSets,
      ...
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$WorkoutTemplateSetsTableFilterComposer(
            $db: $db,
            $table: $db.workoutTemplateSets,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
            $removeJoinBuilderFromRootComposer:
                $removeJoinBuilderFromRootComposer,
...
class $$WorkoutTemplateExercisesTableAnnotationComposer
  ...
  Expression<T> workoutTemplateSetsRefs<T extends Object>(
    Expression<T> Function($$WorkoutTemplateSetsTableAnnotationComposer a) f,
  ) {
    final $$WorkoutTemplateSetsTableAnnotationComposer composer =
        $composerBuilder(
          composer: this,
          getCurrentColumn: (t) => t.id,
          referencedTable: $db.workoutTemplateSets,
          ...
          builder:
              (
                ...
                $addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer,
              }) => $$WorkoutTemplateSetsTableAnnotationComposer(
                $db: $db,
                $table: $db.workoutTemplateSets,
                $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
                joinBuilder: joinBuilder,
        ...
        TableManagerState(
          ...
          prefetchHooksCallback:
              ({
                templateId = false,
                exerciseId = false,
                workoutTemplateSetsRefs = false,
              }) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
                    if (workoutTemplateSetsRefs) db.workoutTemplateSets,
                  ],
                  addJoins:
                      <
                        T extends TableManagerState<
                    ...
                    return [
                      if (workoutTemplateSetsRefs)
                        ...
                        >(
                          ...
                          referencedTable:
                              $$WorkoutTemplateExercisesTableReferences
                                  ._workoutTemplateSetsRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$WorkoutTemplateExercisesTableReferences(
                                db,
                                table,
                                p0,
                              ).workoutTemplateSetsRefs,
                          referencedItemsForCurrentItem:
                              (item, referencedItems) => referencedItems.where(
...
typedef $$WorkoutTemplateExercisesTableProcessedTableManager =
    ...
    >;
typedef $$WorkoutTemplateSetsTableCreateCompanionBuilder =
    WorkoutTemplateSetsCompanion Function({
      required String id,
      required String templateExerciseId,
      required int setNumber,
      Value<int?> reps,
...
typedef $$WorkoutTemplateSetsTableUpdateCompanionBuilder =
    WorkoutTemplateSetsCompanion Function({
      Value<String> id,
      Value<String> templateExerciseId,
      Value<int> setNumber,
...
final class $$WorkoutTemplateSetsTableReferences
    extends
        BaseReferences<
          _$AppDatabase,
          $WorkoutTemplateSetsTable,
          WorkoutTemplateSet
        > {
  $$WorkoutTemplateSetsTableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );

  static $WorkoutTemplateExercisesTable _templateExerciseIdTable(
    _$AppDatabase db,
  ) => db.workoutTemplateExercises.createAlias(
    $_aliasNameGenerator(
      db.workoutTemplateSets.templateExerciseId,
      db.workoutTemplateExercises.id,
    ),
  ...
  $$WorkoutTemplateExercisesTableProcessedTableManager get templateExerciseId {
...
class $$WorkoutTemplateSetsTableFilterComposer
    extends Composer<_$AppDatabase, $WorkoutTemplateSetsTable> {
  $$WorkoutTemplateSetsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
  ...
  $$WorkoutTemplateExercisesTableFilterComposer get templateExerciseId {
    final $$WorkoutTemplateExercisesTableFilterComposer composer =
        $composerBuilder(
          composer: this,
...
class $$WorkoutTemplateSetsTableOrderingComposer
    extends Composer<_$AppDatabase, $WorkoutTemplateSetsTable> {
  $$WorkoutTemplateSetsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  $$WorkoutTemplateExercisesTableOrderingComposer get templateExerciseId {
    final $$WorkoutTemplateExercisesTableOrderingComposer composer =
        $composerBuilder(
          composer: this,
          getCurrentColumn: (t) => t.templateExerciseId,
          referencedTable: $db.workoutTemplateExercises,
...
class $$WorkoutTemplateSetsTableAnnotationComposer
    extends Composer<_$AppDatabase, $WorkoutTemplateSetsTable> {
  $$WorkoutTemplateSetsTableAnnotationComposer({
    required super.$db,
    required super.$table,
  ...
  $$WorkoutTemplateExercisesTableAnnotationComposer get templateExerciseId {
    final $$WorkoutTemplateExercisesTableAnnotationComposer composer =
        $composerBuilder(
          composer: this,
          getCurrentColumn: (t) => t.templateExerciseId,
...
class $$WorkoutTemplateSetsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $WorkoutTemplateSetsTable,
          ...
          $$WorkoutTemplateSetsTableOrderingComposer,
          $$WorkoutTemplateSetsTableAnnotationComposer,
          $$WorkoutTemplateSetsTableCreateCompanionBuilder,
          $$WorkoutTemplateSetsTableUpdateCompanionBuilder,
          (WorkoutTemplateSet, $$WorkoutTemplateSetsTableReferences),
          WorkoutTemplateSet,
          PrefetchHooks Function({bool templateExerciseId})
        > {
  $$WorkoutTemplateSetsTableTableManager(
    _$AppDatabase db,
    $WorkoutTemplateSetsTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$WorkoutTemplateSetsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$WorkoutTemplateSetsTableOrderingComposer(
                $db: db,
                $table: table,
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$WorkoutTemplateSetsTableReferences(db, table, e),
                ),
              )
              .toList(),
...
typedef $$WorkoutTemplateSetsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $WorkoutTemplateSetsTable,
      WorkoutTemplateSet,
...
final class $$TasksTableReferences
  ...
  static MultiTypedResultKey<$TaskExperimentsTable, List<TaskExperiment>>
  _taskExperimentsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.taskExperiments,
    aliasName: $_aliasNameGenerator(db.tasks.id, db.taskExperiments.taskId),
  );

  $$TaskExperimentsTableProcessedTableManager get taskExperimentsRefs {
    final manager = $$TaskExperimentsTableTableManager(
      $_db,
      $_db.taskExperiments,
    ).filter((f) => f.taskId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _taskExperimentsRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  ...
  static MultiTypedResultKey<$TaskGoalsTable, List<TaskGoal>>
  _taskGoalsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.taskGoals,
    aliasName: $_aliasNameGenerator(db.tasks.id, db.taskGoals.taskId),
  );

  $$TaskGoalsTableProcessedTableManager get taskGoalsRefs {
    final manager = $$TaskGoalsTableTableManager(
      $_db,
      $_db.taskGoals,
    ).filter((f) => f.taskId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(_taskGoalsRefsTable($_db));
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  }
...
class $$TasksTableFilterComposer extends Composer<_$AppDatabase, $TasksTable> {
  ...
  Expression<bool> taskExperimentsRefs(
    Expression<bool> Function($$TaskExperimentsTableFilterComposer f) f,
  ) {
    final $$TaskExperimentsTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.taskExperiments,
      ...
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$TaskExperimentsTableFilterComposer(
            $db: $db,
            $table: $db.taskExperiments,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
            $removeJoinBuilderFromRootComposer:
                $removeJoinBuilderFromRootComposer,
  ...
  Expression<bool> taskGoalsRefs(
    Expression<bool> Function($$TaskGoalsTableFilterComposer f) f,
  ) {
    final $$TaskGoalsTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.taskGoals,
      getReferencedColumn: (t) => t.taskId,
      builder:
          (
            joinBuilder, {
...
class $$TasksTableAnnotationComposer
  ...
  Expression<T> taskExperimentsRefs<T extends Object>(
    Expression<T> Function($$TaskExperimentsTableAnnotationComposer a) f,
  ) {
    final $$TaskExperimentsTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.taskExperiments,
      getReferencedColumn: (t) => t.taskId,
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$TaskExperimentsTableAnnotationComposer(
            $db: $db,
            $table: $db.taskExperiments,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
  ...
  Expression<T> taskGoalsRefs<T extends Object>(
    Expression<T> Function($$TaskGoalsTableAnnotationComposer a) f,
  ) {
    final $$TaskGoalsTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.taskGoals,
      getReferencedColumn: (t) => t.taskId,
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$TaskGoalsTableAnnotationComposer(
            $db: $db,
            $table: $db.taskGoals,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
                ...
                return PrefetchHooks(
                  ...
                  getPrefetchedDataCallback: (items) async {
                    return [
                      ...
                      if (taskGoalsRefs)
                        await $_getPrefetchedData<Task, $TasksTable, TaskGoal>(
                          currentTable: table,
                          referencedTable: $$TasksTableReferences
                              ._taskGoalsRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$TasksTableReferences(
                                db,
                                table,
                      ...
                      if (taskNotesRefs)
                        await $_getPrefetchedData<Task, $TasksTable, TaskNote>(
                          currentTable: table,
                          referencedTable: $$TasksTableReferences
...
final class $$ExperimentsTableReferences
  ...
  _taskExperimentsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    ...
    aliasName: $_aliasNameGenerator(
      db.experiments.id,
      db.taskExperiments.experimentId,
    ),
  );
  ...
  static MultiTypedResultKey<$ExperimentGoalsTable, List<ExperimentGoal>>
  _experimentGoalsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.experimentGoals,
    aliasName: $_aliasNameGenerator(
      db.experiments.id,
      db.experimentGoals.experimentId,
    ),
  );

  $$ExperimentGoalsTableProcessedTableManager get experimentGoalsRefs {
    final manager = $$ExperimentGoalsTableTableManager(
      $_db,
      $_db.experimentGoals,
    ).filter((f) => f.experimentId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _experimentGoalsRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  ...
  static MultiTypedResultKey<$ExperimentNotesTable, List<ExperimentNote>>
  _experimentNotesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.experimentNotes,
    aliasName: $_aliasNameGenerator(
      db.experiments.id,
      db.experimentNotes.experimentId,
    ),
  );

  $$ExperimentNotesTableProcessedTableManager get experimentNotesRefs {
    final manager = $$ExperimentNotesTableTableManager(
      $_db,
      $_db.experimentNotes,
    ).filter((f) => f.experimentId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _experimentNotesRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
...
class $$ExperimentsTableFilterComposer
  ...
  Expression<bool> experimentGoalsRefs(
    Expression<bool> Function($$ExperimentGoalsTableFilterComposer f) f,
  ) {
    final $$ExperimentGoalsTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.experimentGoals,
      getReferencedColumn: (t) => t.experimentId,
      builder:
          (
            joinBuilder, {
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$ExperimentGoalsTableFilterComposer(
            $db: $db,
            $table: $db.experimentGoals,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
            $removeJoinBuilderFromRootComposer:
                $removeJoinBuilderFromRootComposer,
  ...
  Expression<bool> experimentNotesRefs(
    Expression<bool> Function($$ExperimentNotesTableFilterComposer f) f,
  ) {
    final $$ExperimentNotesTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.experimentNotes,
      getReferencedColumn: (t) => t.experimentId,
      builder:
          (
            joinBuilder, {
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$ExperimentNotesTableFilterComposer(
            $db: $db,
            $table: $db.experimentNotes,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
            $removeJoinBuilderFromRootComposer:
                $removeJoinBuilderFromRootComposer,
...
class $$ExperimentsTableAnnotationComposer
  ...
  Expression<T> experimentGoalsRefs<T extends Object>(
    Expression<T> Function($$ExperimentGoalsTableAnnotationComposer a) f,
  ) {
    final $$ExperimentGoalsTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.experimentGoals,
      getReferencedColumn: (t) => t.experimentId,
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$ExperimentGoalsTableAnnotationComposer(
            $db: $db,
            $table: $db.experimentGoals,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
  ...
  Expression<T> experimentNotesRefs<T extends Object>(
    Expression<T> Function($$ExperimentNotesTableAnnotationComposer a) f,
  ) {
    final $$ExperimentNotesTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.experimentNotes,
      getReferencedColumn: (t) => t.experimentId,
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$ExperimentNotesTableAnnotationComposer(
            $db: $db,
            $table: $db.experimentNotes,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
...
final class $$NotesTableReferences
  ...
  _taskNotesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.taskNotes,
    aliasName: $_aliasNameGenerator(db.notes.id, db.taskNotes.noteId),
  );
  ...
  _experimentNotesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.experimentNotes,
    aliasName: $_aliasNameGenerator(db.notes.id, db.experimentNotes.noteId),
  );
  ...
  static MultiTypedResultKey<$GoalNotesTable, List<GoalNote>>
  _goalNotesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.goalNotes,
    aliasName: $_aliasNameGenerator(db.notes.id, db.goalNotes.noteId),
  );

  $$GoalNotesTableProcessedTableManager get goalNotesRefs {
    final manager = $$GoalNotesTableTableManager(
      $_db,
      $_db.goalNotes,
    ).filter((f) => f.noteId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(_goalNotesRefsTable($_db));
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  }
  ...
  _noteWorkoutsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.noteWorkouts,
    aliasName: $_aliasNameGenerator(db.notes.id, db.noteWorkouts.noteId),
  );
...
class $$NotesTableFilterComposer extends Composer<_$AppDatabase, $NotesTable> {
  ...
  Expression<bool> goalNotesRefs(
    Expression<bool> Function($$GoalNotesTableFilterComposer f) f,
  ) {
    final $$GoalNotesTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.goalNotes,
      getReferencedColumn: (t) => t.noteId,
      builder:
          (
            joinBuilder, {
...
class $$NotesTableAnnotationComposer
  ...
  Expression<T> goalNotesRefs<T extends Object>(
    Expression<T> Function($$GoalNotesTableAnnotationComposer a) f,
  ) {
    final $$GoalNotesTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.goalNotes,
      getReferencedColumn: (t) => t.noteId,
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$GoalNotesTableAnnotationComposer(
            $db: $db,
            $table: $db.goalNotes,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
              ...
              ({
                ...
                return PrefetchHooks(
                  ...
                  getPrefetchedDataCallback: (items) async {
                    return [
                      if (taskNotesRefs)
                        await $_getPrefetchedData<Note, $NotesTable, TaskNote>(
                          currentTable: table,
                      ...
                      if (goalNotesRefs)
                        await $_getPrefetchedData<Note, $NotesTable, GoalNote>(
                          currentTable: table,
                          referencedTable: $$NotesTableReferences
                              ._goalNotesRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$NotesTableReferences(
                                db,
                                table,
...
final class $$GoalsTableReferences
  ...
  _taskGoalsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.taskGoals,
    aliasName: $_aliasNameGenerator(db.goals.id, db.taskGoals.goalId),
  );
  ...
  _experimentGoalsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.experimentGoals,
    aliasName: $_aliasNameGenerator(db.goals.id, db.experimentGoals.goalId),
  );
  ...
  _goalNotesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.goalNotes,
    aliasName: $_aliasNameGenerator(db.goals.id, db.goalNotes.goalId),
  );
  ...
  _goalWorkoutsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.goalWorkouts,
    aliasName: $_aliasNameGenerator(db.goals.id, db.goalWorkouts.goalId),
  );
              ...
              ({
                ...
                return PrefetchHooks(
                  ...
                  getPrefetchedDataCallback: (items) async {
                    return [
                      if (taskGoalsRefs)
                        await $_getPrefetchedData<Goal, $GoalsTable, TaskGoal>(
                          currentTable: table,
                      ...
                      if (goalNotesRefs)
                        await $_getPrefetchedData<Goal, $GoalsTable, GoalNote>(
                          currentTable: table,
                          referencedTable: $$GoalsTableReferences
                              ._goalNotesRefsTable(db),
                          managerFromTypedResult: (p0) =>
...
class $$GoalProgressEntriesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
  ...
  $$GoalProgressEntriesTableTableManager(
    _$AppDatabase db,
    $GoalProgressEntriesTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
...
typedef $$GoalProgressEntriesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $GoalProgressEntriesTable,
      GoalProgressEntry,
      ...
      PrefetchHooks Function()
    >;
typedef $$TaskExperimentsTableCreateCompanionBuilder =
    TaskExperimentsCompanion Function({
      required String taskId,
      required String experimentId,
      Value<String?> label,
      Value<int> rowid,
    });
typedef $$TaskExperimentsTableUpdateCompanionBuilder =
    TaskExperimentsCompanion Function({
      Value<String> taskId,
      Value<String> experimentId,
      Value<String?> label,
...
final class $$TaskExperimentsTableReferences
    extends
        BaseReferences<_$AppDatabase, $TaskExperimentsTable, TaskExperiment> {
  $$TaskExperimentsTableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );
  ...
  static $TasksTable _taskIdTable(_$AppDatabase db) => db.tasks.createAlias(
    $_aliasNameGenerator(db.taskExperiments.taskId, db.tasks.id),
  );
...
class $$TaskExperimentsTableFilterComposer
    extends Composer<_$AppDatabase, $TaskExperimentsTable> {
  $$TaskExperimentsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$TaskExperimentsTableOrderingComposer
    extends Composer<_$AppDatabase, $TaskExperimentsTable> {
  $$TaskExperimentsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$TaskExperimentsTableAnnotationComposer
    extends Composer<_$AppDatabase, $TaskExperimentsTable> {
  $$TaskExperimentsTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$TaskExperimentsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $TaskExperimentsTable,
          TaskExperiment,
          $$TaskExperimentsTableFilterComposer,
          $$TaskExperimentsTableOrderingComposer,
          $$TaskExperimentsTableAnnotationComposer,
          $$TaskExperimentsTableCreateCompanionBuilder,
          $$TaskExperimentsTableUpdateCompanionBuilder,
          (TaskExperiment, $$TaskExperimentsTableReferences),
          TaskExperiment,
          PrefetchHooks Function({bool taskId, bool experimentId})
        > {
  $$TaskExperimentsTableTableManager(
    _$AppDatabase db,
    $TaskExperimentsTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$TaskExperimentsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$TaskExperimentsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$TaskExperimentsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$TaskExperimentsTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback: ({taskId = false, experimentId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins:
...
typedef $$TaskExperimentsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $TaskExperimentsTable,
      TaskExperiment,
      ...
      PrefetchHooks Function({bool taskId, bool experimentId})
    >;
typedef $$TaskGoalsTableCreateCompanionBuilder =
    TaskGoalsCompanion Function({
      required String taskId,
      required String goalId,
      Value<String?> label,
      Value<int> rowid,
    });
typedef $$TaskGoalsTableUpdateCompanionBuilder =
    TaskGoalsCompanion Function({
      Value<String> taskId,
      Value<String> goalId,
      Value<String?> label,
...
final class $$TaskGoalsTableReferences
    extends BaseReferences<_$AppDatabase, $TaskGoalsTable, TaskGoal> {
  $$TaskGoalsTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $TasksTable _taskIdTable(_$AppDatabase db) => db.tasks.createAlias(
    $_aliasNameGenerator(db.taskGoals.taskId, db.tasks.id),
  );
  ...
  static $GoalsTable _goalIdTable(_$AppDatabase db) => db.goals.createAlias(
    $_aliasNameGenerator(db.taskGoals.goalId, db.goals.id),
  );
...
class $$TaskGoalsTableFilterComposer
    extends Composer<_$AppDatabase, $TaskGoalsTable> {
  $$TaskGoalsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$TaskGoalsTableOrderingComposer
    extends Composer<_$AppDatabase, $TaskGoalsTable> {
  $$TaskGoalsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$TaskGoalsTableAnnotationComposer
    extends Composer<_$AppDatabase, $TaskGoalsTable> {
  $$TaskGoalsTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$TaskGoalsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $TaskGoalsTable,
          ...
          $$TaskGoalsTableOrderingComposer,
          $$TaskGoalsTableAnnotationComposer,
          $$TaskGoalsTableCreateCompanionBuilder,
          $$TaskGoalsTableUpdateCompanionBuilder,
          (TaskGoal, $$TaskGoalsTableReferences),
          TaskGoal,
          PrefetchHooks Function({bool taskId, bool goalId})
        > {
  $$TaskGoalsTableTableManager(_$AppDatabase db, $TaskGoalsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$TaskGoalsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$TaskGoalsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$TaskGoalsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> taskId = const Value.absent(),
                Value<String> goalId = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$TaskGoalsTableReferences(db, table, e),
                ),
              )
              .toList(),
                    ...
                    if (taskId) {
                      state =
                          state.withJoin(
                                currentTable: table,
                                currentColumn: table.taskId,
                                referencedTable: $$TaskGoalsTableReferences
                                    ._taskIdTable(db),
                                referencedColumn: $$TaskGoalsTableReferences
                                    ._taskIdTable(db)
                                    .id,
                              )
                              as T;
...
typedef $$TaskGoalsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $TaskGoalsTable,
      TaskGoal,
      ...
      PrefetchHooks Function({bool taskId, bool goalId})
    >;
typedef $$ExperimentGoalsTableCreateCompanionBuilder =
    ExperimentGoalsCompanion Function({
      required String experimentId,
      required String goalId,
      Value<String?> label,
      Value<int> rowid,
    });
typedef $$ExperimentGoalsTableUpdateCompanionBuilder =
    ExperimentGoalsCompanion Function({
      Value<String> experimentId,
      Value<String> goalId,
      Value<String?> label,
...
final class $$ExperimentGoalsTableReferences
    extends
        BaseReferences<_$AppDatabase, $ExperimentGoalsTable, ExperimentGoal> {
  $$ExperimentGoalsTableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );
  ...
  static $GoalsTable _goalIdTable(_$AppDatabase db) => db.goals.createAlias(
    $_aliasNameGenerator(db.experimentGoals.goalId, db.goals.id),
  );
...
class $$ExperimentGoalsTableFilterComposer
    extends Composer<_$AppDatabase, $ExperimentGoalsTable> {
  $$ExperimentGoalsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$ExperimentGoalsTableOrderingComposer
    extends Composer<_$AppDatabase, $ExperimentGoalsTable> {
  $$ExperimentGoalsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ExperimentGoalsTableAnnotationComposer
    extends Composer<_$AppDatabase, $ExperimentGoalsTable> {
  $$ExperimentGoalsTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$ExperimentGoalsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $ExperimentGoalsTable,
          ExperimentGoal,
          $$ExperimentGoalsTableFilterComposer,
          $$ExperimentGoalsTableOrderingComposer,
          $$ExperimentGoalsTableAnnotationComposer,
          $$ExperimentGoalsTableCreateCompanionBuilder,
          $$ExperimentGoalsTableUpdateCompanionBuilder,
          (ExperimentGoal, $$ExperimentGoalsTableReferences),
          ExperimentGoal,
          PrefetchHooks Function({bool experimentId, bool goalId})
        > {
  $$ExperimentGoalsTableTableManager(
    _$AppDatabase db,
    $ExperimentGoalsTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$ExperimentGoalsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$ExperimentGoalsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$ExperimentGoalsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> experimentId = const Value.absent(),
                Value<String> goalId = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$ExperimentGoalsTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback: ({experimentId = false, goalId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins:
...
typedef $$ExperimentGoalsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $ExperimentGoalsTable,
      ExperimentGoal,
...
final class $$TaskNotesTableReferences
  ...
  static $NotesTable _noteIdTable(_$AppDatabase db) => db.notes.createAlias(
    $_aliasNameGenerator(db.taskNotes.noteId, db.notes.id),
  );
...
typedef $$TaskNotesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool taskId, bool noteId})
    >;
typedef $$ExperimentNotesTableCreateCompanionBuilder =
    ExperimentNotesCompanion Function({
      required String experimentId,
      required String noteId,
      Value<String?> label,
      Value<int> rowid,
    });
typedef $$ExperimentNotesTableUpdateCompanionBuilder =
    ExperimentNotesCompanion Function({
      Value<String> experimentId,
      Value<String> noteId,
      Value<String?> label,
...
final class $$ExperimentNotesTableReferences
    extends
        BaseReferences<_$AppDatabase, $ExperimentNotesTable, ExperimentNote> {
  $$ExperimentNotesTableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );
  ...
  static $NotesTable _noteIdTable(_$AppDatabase db) => db.notes.createAlias(
    $_aliasNameGenerator(db.experimentNotes.noteId, db.notes.id),
  );
...
class $$ExperimentNotesTableFilterComposer
    extends Composer<_$AppDatabase, $ExperimentNotesTable> {
  $$ExperimentNotesTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$ExperimentNotesTableOrderingComposer
    extends Composer<_$AppDatabase, $ExperimentNotesTable> {
  $$ExperimentNotesTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ExperimentNotesTableAnnotationComposer
    extends Composer<_$AppDatabase, $ExperimentNotesTable> {
  $$ExperimentNotesTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$ExperimentNotesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $ExperimentNotesTable,
          ExperimentNote,
          $$ExperimentNotesTableFilterComposer,
          $$ExperimentNotesTableOrderingComposer,
          $$ExperimentNotesTableAnnotationComposer,
          $$ExperimentNotesTableCreateCompanionBuilder,
          $$ExperimentNotesTableUpdateCompanionBuilder,
          (ExperimentNote, $$ExperimentNotesTableReferences),
          ExperimentNote,
          PrefetchHooks Function({bool experimentId, bool noteId})
        > {
  $$ExperimentNotesTableTableManager(
    _$AppDatabase db,
    $ExperimentNotesTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$ExperimentNotesTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$ExperimentNotesTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$ExperimentNotesTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> experimentId = const Value.absent(),
                Value<String> noteId = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$ExperimentNotesTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback: ({experimentId = false, noteId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins:
...
typedef $$ExperimentNotesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $ExperimentNotesTable,
      ExperimentNote,
      ...
      PrefetchHooks Function({bool experimentId, bool noteId})
    >;
typedef $$GoalNotesTableCreateCompanionBuilder =
    GoalNotesCompanion Function({
      required String goalId,
      required String noteId,
      Value<String?> label,
      Value<int> rowid,
    });
typedef $$GoalNotesTableUpdateCompanionBuilder =
    GoalNotesCompanion Function({
      Value<String> goalId,
      Value<String> noteId,
      Value<String?> label,
...
final class $$GoalNotesTableReferences
    extends BaseReferences<_$AppDatabase, $GoalNotesTable, GoalNote> {
  $$GoalNotesTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $GoalsTable _goalIdTable(_$AppDatabase db) => db.goals.createAlias(
    $_aliasNameGenerator(db.goalNotes.goalId, db.goals.id),
  );
  ...
  static $NotesTable _noteIdTable(_$AppDatabase db) => db.notes.createAlias(
    $_aliasNameGenerator(db.goalNotes.noteId, db.notes.id),
  );
...
class $$GoalNotesTableFilterComposer
    extends Composer<_$AppDatabase, $GoalNotesTable> {
  $$GoalNotesTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$GoalNotesTableOrderingComposer
    extends Composer<_$AppDatabase, $GoalNotesTable> {
  $$GoalNotesTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$GoalNotesTableAnnotationComposer
    extends Composer<_$AppDatabase, $GoalNotesTable> {
  $$GoalNotesTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$GoalNotesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $GoalNotesTable,
          ...
          $$GoalNotesTableOrderingComposer,
          $$GoalNotesTableAnnotationComposer,
          $$GoalNotesTableCreateCompanionBuilder,
          $$GoalNotesTableUpdateCompanionBuilder,
          (GoalNote, $$GoalNotesTableReferences),
          GoalNote,
          PrefetchHooks Function({bool goalId, bool noteId})
        > {
  $$GoalNotesTableTableManager(_$AppDatabase db, $GoalNotesTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$GoalNotesTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$GoalNotesTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$GoalNotesTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> goalId = const Value.absent(),
                Value<String> noteId = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$GoalNotesTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback: ({goalId = false, noteId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins:
                    ...
                    if (goalId) {
                      state =
                          state.withJoin(
                                currentTable: table,
                                currentColumn: table.goalId,
                                referencedTable: $$GoalNotesTableReferences
                                    ._goalIdTable(db),
                                referencedColumn: $$GoalNotesTableReferences
                                    ._goalIdTable(db)
                                    .id,
                              )
                              as T;
...
typedef $$GoalNotesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $GoalNotesTable,
      GoalNote,
      ...
      PrefetchHooks Function({bool goalId, bool noteId})
    >;
typedef $$GoalWorkoutsTableCreateCompanionBuilder =
    GoalWorkoutsCompanion Function({
      required String goalId,
      required String workoutId,
      Value<String?> label,
      Value<int> rowid,
    });
typedef $$GoalWorkoutsTableUpdateCompanionBuilder =
    GoalWorkoutsCompanion Function({
      Value<String> goalId,
      Value<String> workoutId,
      Value<String?> label,
...
final class $$GoalWorkoutsTableReferences
    extends BaseReferences<_$AppDatabase, $GoalWorkoutsTable, GoalWorkout> {
  $$GoalWorkoutsTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $GoalsTable _goalIdTable(_$AppDatabase db) => db.goals.createAlias(
    $_aliasNameGenerator(db.goalWorkouts.goalId, db.goals.id),
  );
  ...
  static $WorkoutsTable _workoutIdTable(_$AppDatabase db) =>
      db.workouts.createAlias(
        $_aliasNameGenerator(db.goalWorkouts.workoutId, db.workouts.id),
      );
...
class $$GoalWorkoutsTableFilterComposer
    extends Composer<_$AppDatabase, $GoalWorkoutsTable> {
  $$GoalWorkoutsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$GoalWorkoutsTableOrderingComposer
    extends Composer<_$AppDatabase, $GoalWorkoutsTable> {
  $$GoalWorkoutsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$GoalWorkoutsTableAnnotationComposer
    extends Composer<_$AppDatabase, $GoalWorkoutsTable> {
  $$GoalWorkoutsTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$GoalWorkoutsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $GoalWorkoutsTable,
          ...
          $$GoalWorkoutsTableOrderingComposer,
          $$GoalWorkoutsTableAnnotationComposer,
          $$GoalWorkoutsTableCreateCompanionBuilder,
          $$GoalWorkoutsTableUpdateCompanionBuilder,
          (GoalWorkout, $$GoalWorkoutsTableReferences),
          GoalWorkout,
          PrefetchHooks Function({bool goalId, bool workoutId})
        > {
  $$GoalWorkoutsTableTableManager(_$AppDatabase db, $GoalWorkoutsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$GoalWorkoutsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$GoalWorkoutsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$GoalWorkoutsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> goalId = const Value.absent(),
                Value<String> workoutId = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$GoalWorkoutsTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback: ({goalId = false, workoutId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins:
                    ...
                    if (goalId) {
                      state =
                          state.withJoin(
                                currentTable: table,
                                currentColumn: table.goalId,
                                referencedTable: $$GoalWorkoutsTableReferences
                                    ._goalIdTable(db),
                                referencedColumn: $$GoalWorkoutsTableReferences
                                    ._goalIdTable(db)
                                    .id,
                              )
                              as T;
...
typedef $$GoalWorkoutsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $GoalWorkoutsTable,
      GoalWorkout,
      ...
      PrefetchHooks Function({bool goalId, bool workoutId})
    >;
typedef $$NoteWorkoutsTableCreateCompanionBuilder =
    NoteWorkoutsCompanion Function({
      required String noteId,
      required String workoutId,
      Value<String?> label,
      Value<int> rowid,
    });
typedef $$NoteWorkoutsTableUpdateCompanionBuilder =
    NoteWorkoutsCompanion Function({
      Value<String> noteId,
      Value<String> workoutId,
      Value<String?> label,
...
final class $$NoteWorkoutsTableReferences
    extends BaseReferences<_$AppDatabase, $NoteWorkoutsTable, NoteWorkout> {
  $$NoteWorkoutsTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $NotesTable _noteIdTable(_$AppDatabase db) => db.notes.createAlias(
    $_aliasNameGenerator(db.noteWorkouts.noteId, db.notes.id),
  );
  ...
  static $WorkoutsTable _workoutIdTable(_$AppDatabase db) =>
      db.workouts.createAlias(
        $_aliasNameGenerator(db.noteWorkouts.workoutId, db.workouts.id),
      );
...
class $$NoteWorkoutsTableFilterComposer
    extends Composer<_$AppDatabase, $NoteWorkoutsTable> {
  $$NoteWorkoutsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$NoteWorkoutsTableOrderingComposer
    extends Composer<_$AppDatabase, $NoteWorkoutsTable> {
  $$NoteWorkoutsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$NoteWorkoutsTableAnnotationComposer
    extends Composer<_$AppDatabase, $NoteWorkoutsTable> {
  $$NoteWorkoutsTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$NoteWorkoutsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $NoteWorkoutsTable,
          ...
          $$NoteWorkoutsTableOrderingComposer,
          $$NoteWorkoutsTableAnnotationComposer,
          $$NoteWorkoutsTableCreateCompanionBuilder,
          $$NoteWorkoutsTableUpdateCompanionBuilder,
          (NoteWorkout, $$NoteWorkoutsTableReferences),
          NoteWorkout,
          PrefetchHooks Function({bool noteId, bool workoutId})
        > {
  $$NoteWorkoutsTableTableManager(_$AppDatabase db, $NoteWorkoutsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$NoteWorkoutsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$NoteWorkoutsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$NoteWorkoutsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> noteId = const Value.absent(),
                Value<String> workoutId = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$NoteWorkoutsTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback: ({noteId = false, workoutId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins:
                    ...
                    if (noteId) {
                      state =
                          state.withJoin(
                                currentTable: table,
                                currentColumn: table.noteId,
                                referencedTable: $$NoteWorkoutsTableReferences
                                    ._noteIdTable(db),
                                referencedColumn: $$NoteWorkoutsTableReferences
                                    ._noteIdTable(db)
                                    .id,
                              )
                              as T;
...
typedef $$NoteWorkoutsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $NoteWorkoutsTable,
      NoteWorkout,
...
class $AppDatabaseManager {
  ...
  $$IngredientPicturesTableTableManager get ingredientPictures =>
  ...
  $$WorkoutTemplateSetsTableTableManager get workoutTemplateSets =>
      $$WorkoutTemplateSetsTableTableManager(_db, _db.workoutTemplateSets);
  ...
  $$TaskExperimentsTableTableManager get taskExperiments =>
      $$TaskExperimentsTableTableManager(_db, _db.taskExperiments);
  $$TaskGoalsTableTableManager get taskGoals =>
      $$TaskGoalsTableTableManager(_db, _db.taskGoals);
  $$ExperimentGoalsTableTableManager get experimentGoals =>
      $$ExperimentGoalsTableTableManager(_db, _db.experimentGoals);
  $$TaskNotesTableTableManager get taskNotes =>
      $$TaskNotesTableTableManager(_db, _db.taskNotes);
  $$ExperimentNotesTableTableManager get experimentNotes =>
      $$ExperimentNotesTableTableManager(_db, _db.experimentNotes);
  $$GoalNotesTableTableManager get goalNotes =>
      $$GoalNotesTableTableManager(_db, _db.goalNotes);
  $$GoalWorkoutsTableTableManager get goalWorkouts =>
