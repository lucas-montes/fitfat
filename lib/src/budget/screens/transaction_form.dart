  ...
  Future<void> _save() async {
    ...
    if (_type == TransactionType.transfer) {
      if (_accountId == null || _toAccountId == null) {
        showTopBanner(
          context,
          message: l10n.transactionTransferAccountsRequired,
        );
        return;
      }
        ...
        title: Text(
          _isEditing
              ...
              : switch (_type) {
                  ...
                  TransactionType.transfer => l10n.transactionFormTransferTitle,
      ...
      children: [
        ...
        if (localPath != null) ...[
          ...
          ClipRRect(
            ...
            child: Image.file(File(localPath!), height: 160, fit: BoxFit.cover),
          ),
        ],
      ],
    );
