...
| Plans | [plans/barebone-crud-app.md](plans/barebone-crud-app.md) | Active implementation plan |
| Database | [database/schema.md](database/schema.md) | Full schema: tables, columns, types, generated code |
| Diet | [diet/ingredient-crud.md](diet/ingredient-crud.md) | Ingredient CRUD: repository, providers, screens |
| Diet | [diet/meal-crud.md](diet/meal-crud.md) | Meal CRUD: repository, providers, screens |
| Exercise | [exercise/exercise-crud.md](exercise/exercise-crud.md) | Exercise definition CRUD: repository, providers, screens |
| Exercise | [exercise/workout-crud.md](exercise/workout-crud.md) | Workout CRUD: repository, providers, screens, workflow |
| Dashboard | [dashboard/dashboard.md](dashboard/dashboard.md) | Dashboard: today's calories, latest workout |
